...
abstract class Skin_Base extends Elementor_Skin_Base
{
    ...
    protected function render_loop_start()
    {
        ...
        $this->get_parent()->add_render_attribute('container', ['class' => ['dce-posts-container', 'dce-posts', 'dce-dynamic-posts-collection', 'dce-fix-background-loop', $this->get_scrollreveal_class(), $this->get_container_class()]]);
