...
pdfjsLib.getDocument(url).promise.then((pdf)=>{myState.pdf=pdf;myState.zoom=elementSettings.zoom;render()});if('yes'===elementSettings.navigation_controls){scope.getElementsByClassName('dce-pdf-go-previous')[0].addEventListener('click',(e)=>{if(myState.pdf==null||myState.currentPage==1)
